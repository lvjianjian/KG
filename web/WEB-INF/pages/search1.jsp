                        ...
                        <div class="box-header">
                            ...
                            <div class="box-tools pull-right">
                                <div class="form-inline">
                                    ...
                                    <button type="button" class="btn btn-sm btn-default bg-gray" id="entity_search">
                                        Search
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="box-body">
                            <table class="table table-striped text-center">
                                <tr class="row">
                                    ...
                                    <td style="width: 50%"><a href="http://dbpedia.org/ontology/Organisation"
                                                              target="_black">http://dbpedia.org/ontology/Organisation</a>
                                    </td>
                                </tr>
                                <tr class="row">
                                    <td style="width: 50%"><a href="https://www.w3.org/1999/02/22-rdf-syntax-ns#type"
...
<script>
    ...
    $("#entity_name").on('keypress', function (event) {
        if (event.keyCode == 13) {
            var mention = $(this).text();
            $("#entity_name").val(mention);
            ment_search(mention);
